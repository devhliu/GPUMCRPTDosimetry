...
## Overview
This document summarizes all issues encountered while implementing and testing Monte Carlo dosimetry calculations across four engine modes: local_deposit, photon_only, photon_em_condensedhistory, and photon_em_energybucketed in the gpumcrpt package.
...
| photon_only | Photon transport with Woodcock tracking | ✅ Working |
| photon_em_condensedhistory | Full photon + condensed history charged particle transport | ✅ Working |
...
- **Engine Mode**: photon_em_condensedhistory, photon_em_energybucketed
...
- **Affected Files**:
  - `src/gpumcrpt/transport/engine_gpu_triton_photon_em_condensedhistory.py`
  - `src/gpumcrpt/transport/engine_gpu_triton_photon_em_energybucketed.py`
- **Category**: RNG/Initialization
- **Engine Mode**: photon_em_condensedhistory, photon_em_energybucketed
...
- **Status**: ✅ Working correctly
- **Description**: The photon_only engine worked without issues after initial setup, implementing Woodcock flight and photon interactions
- **Affected Files**:
  - `src/gpumcrpt/transport/engine_gpu_triton_photon_only.py`
- **Category**: Engine-Specific
- **Engine Mode**: photon_only
...
- **Affected Files**:
  - `src/gpumcrpt/transport/engine_gpu_triton_photon_em_condensedhistory.py`
- **Category**: Engine-Specific
- **Engine Mode**: photon_em_condensedhistory
...
| photon_only | 0 (12.2 - no issues) | ✅ Working |
| photon_em_condensedhistory | 8 (5.3, 5.4, 8.1, 9.1, 9.2, 9.3, 9.4, 9.5, 10.1, 10.2, 11.1, 12.3) | ✅ Working |
...
2. `src/gpumcrpt/transport/engine_gpu_triton_photon_em_condensedhistory.py` - Condensed history engine (8 issues)
3. `src/gpumcrpt/transport/engine_gpu_triton_photon_only.py` - Photon only engine (0 issues)
...
### Phase 1: Initial Setup (local_deposit, photon_only)
- ✅ local_deposit engine: No issues encountered
- ✅ photon_only engine: No issues encountered
...
All four engine modes (local_deposit, photon_only, photon_em_condensedhistory, and photon_em_energybucketed) are now working correctly and ready for dosimetry calculations.
...
- CondensedHistory engine: [engine_gpu_triton_photon_em_condensedhistory.py](file:///mnt/d/WSL/workspace/devhliu/Dosimetry/MCGPURPTDosimetry/GPUMCRPTDosimetry/src/gpumcrpt/transport/engine_gpu_triton_photon_em_condensedhistory.py)
